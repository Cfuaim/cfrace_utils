...
scoreboard players set #Calc cfru_ra_gen 1200
execute store result score #CFRU_Min cfru_ra_gen run scoreboard players operation #CFRU_Min cfru_ra_gen /= #Calc cfru_ra_gen
execute store result score #CFRU_Sec cfru_ra_gen run scoreboard players operation #CFRU_Sec cfru_ra_gen %= #Calc cfru_ra_gen
execute store result score #CFRU_Cse cfru_ra_gen run scoreboard players operation #CFRU_Cse cfru_ra_gen %= #Calc cfru_ra_gen
scoreboard players set #Calc cfru_ra_gen 20
execute store result score #CFRU_Sec cfru_ra_gen run scoreboard players operation #CFRU_Sec cfru_ra_gen /= #Calc cfru_ra_gen
execute store result score #CFRU_Cse cfru_ra_gen run scoreboard players operation #CFRU_Cse cfru_ra_gen %= #Calc cfru_ra_gen
scoreboard players set #Calc cfru_ra_gen 5
execute store result score #CFRU_Cse cfru_ra_gen run scoreboard players operation #CFRU_Cse cfru_ra_gen *= #Calc cfru_ra_gen
#出力用
